...
#                         IHEP, CERN
#################################################################
#        Python script with functionality to kill all
#        crab jobs in a given directory and get status
#        of all jobs in a given directory.
#        WARNING: 'resubmit' doesnt currently work.
#################################################################
    ...
    for files in os.listdir(directory_name):
        ...
        if 'crab_DM_Codex' in files:
            ...
            if crab_mode == 'status':
                ...
                print 'Resubmitting all crab jobs in directory.'
